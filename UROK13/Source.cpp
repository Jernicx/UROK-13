...
GLuint gWVPLocation;// указаетль в виде uniform переменной
...
static void RenderSceneCB()
{
    ...
    Vector3f CameraPos(0.0f, 0.0f, -3.0f);//нахождение камеры
    Vector3f CameraTarget(0.0f, 0.0f, 2.0f);
    Vector3f CameraUp(0.0f, 1.0f, 0.0f);
    p.SetCamera(CameraPos, CameraTarget, CameraUp); // установка
...
static void CreateVertexBuffer()
{
    ...
    Vertices[0] = Vector3f(-1.0f, -1.0f, 0.5773f);// 4 вершины дл€ треугольника
